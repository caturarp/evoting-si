								    	...
								    	<div class="modal-content">
									      	...
									      	<div class="modal-body">
									        	<div class="form-group">
									        		<label>ID</label>
									        		<input type="text" name="kh_id" class="form-control">
									        	</div>
									        	<div class="form-group">
									        		<label>Nama Team</label>
									        		<input type="text" name="kh_nama" class="form-control">
									        	</div>
									        	<div class="form-group">
									        		<label>Visi</label>
									        		<textarea name="kh_visi" id="kh_visi" class="form-control" maxlength="1024" required></textarea>
		        									<script>CKEDITOR.replace('kh_visi');</script>
									        	</div>
									        	<div class="form-group">
									        		<label>Misi</label>
									        		<textarea name="kh_misi" id="kh_misi" class="form-control" maxlength="1024" required></textarea>
								...
								<table class="table table-hover">
									...
									<tbody>
										...
										<tr>
											...
											<td width="12%">
												<a href="<?php echo base_url() ?>admin/kelola/kandidat/?hima&kelola=<?php echo $row->KH_ID ?>" class="btn btn-success">Kelola</a>
											</td>
										</tr>
										<?php
											}
