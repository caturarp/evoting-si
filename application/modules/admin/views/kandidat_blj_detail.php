			...
			<div class="col-md-9">
				<div class="panel panel-default">
					<div class="panel-body" style="min-height: 500px;">
						...
						<div class="row">
							<div class="col-md-12">
								<a href="<?php echo base_url() ?>admin/kelola/kandidat/?blj"><i class="fas fa-chevron-left"></i> Kembali</a>
								<br/><br/>
								<!-- Modal -->
								  	...
								  	<div class="modal-dialog" role="document">
								    	...
								    	<div class="modal-content">
									      	<div class="modal-header">
									        	...
									        	<h4 class="modal-title" id="myModalLabel">Edit Kandidat BLJ</h4>
									      	</div>
									      	<div class="modal-body">
									        	<div class="form-group">
									        		<label>ID</label>
									        		<input type="text" name="kb_id" class="form-control" value="<?php echo $row->KB_ID ?>" readonly>
									        	</div>
									        	<div class="form-group">
									        		<label>Nama Team</label>
									        		<input type="text" name="kb_nama" value="<?php echo $row->KB_NAMA?>" class="form-control">
									        	</div>
									        	<div class="form-group">
									        		<label>Visi</label>
									        		<textarea name="kb_visi" id="kb_visi" class="form-control" maxlength="1024" required>
									        			<?php echo $row->KB_VISI ?>
									        		</textarea>
		        									<script>CKEDITOR.replace('kb_visi');</script>
									        	</div>
									        	<div class="form-group">
									        		<label>Misi</label>
									        		<textarea name="kb_misi" id="kb_misi" class="form-control" maxlength="1024" required>
									        			<?php echo $row->KB_MISI ?>
									        		</textarea>
									...
									<div class="panel-body">
										<table class="table">
											...
											<tr>
												...
												<td valign="top">:</td>
												<td valign="top"><?php echo $row->KB_VISI?></td>
											</tr>
											<tr>
												<td valign="top">Misi</td>
												<td valign="top">:</td>
												<td valign="top"><?php echo $row->KB_MISI?></td>
											</tr>
											<?php
												}
											?>
								  	...
								  	<div class="modal-dialog" role="document">
								    	...
								    	<div class="modal-content">
									      	...
									      	<div class="modal-body">
									        	...
									        	<div class="form-group">
									        		<label>Foto</label>
									        		<input type="file" name="dkb_foto" accept="image/jpeg, image/png" class="form-control">
									        	</div>
									      	</div>
									      	<div class="modal-footer">
									        	<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
						...
						<div class="row">
							<div class="col-md-12">
								<div style="border-bottom: 2px blue solid; font-size: 14pt;">
									<center><b>Calon Delegasi BLJ</b></center>
								</div>
								<br/>
							</div>
						</div>
								...
								<div class="panel panel-info">
									<div class="panel-heading">
										<table width="100%">
											<tr>
												<td width="20%" style="text-align: right;">
													<a href="<?php echo base_url() ?>admin/kelola/kandidat/?blj&kelola=<?php echo $this->input->get('kelola')?>&hapus=<?php echo $row->MAHASISWA_NPM ?>" class="btn btn-danger"><i class="fas fa-times"></i></a>
												</td>
											</tr>
										</table>
									</div>
									<div class="panel-body">
										<center>
											<img style="width: 150px; border-radius: 150px; border: 2px solid black;" src="<?php echo base_url() ?>admin/kelola/foto/blj/?kb_id=<?php echo $row->KB_ID ?>&mahasiswa_npm=<?php echo $row->MAHASISWA_NPM ?>"><br/><br/>
										</center>
										<table class="table">
											<tr>
												<td>NPM</td>
