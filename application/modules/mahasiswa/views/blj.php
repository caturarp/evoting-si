		...
		<div class="row">
			<div class="col-md-12">
				<div style="border-bottom: solid blue 2px;">
					<center>
						<h3>Voting Calon Delegasi BLJ HIMASIFO Angkatan <?php echo "20".substr($this->session->userdata('user_id'),0,2)?></h3>
					</center>
				</div>
				<br/>
			</div>
						...
						<table width="100%" border="1">
							<tr>
								<td valign="top" width="20%">
									<br/>
									<?php
										$mahasiswa = $this->m_mahasiswa->voting_kb_view_kandidat($kb_id);
										foreach($mahasiswa->result() as $row1){
											$mahasiswa_npm = $row1->MAHASISWA_NPM;
									?>
									<center>
									<img style="width: 100px; border-radius: 100px; border: 2px solid black;" src="<?php echo base_url() ?>mahasiswa/voting/foto/blj/?kb_id=<?php echo $row->KB_ID ?>&mahasiswa_npm=<?php echo $row1->MAHASISWA_NPM ?>"><br/>
								...
								<td valign="center">
									<center>
										<a href="<?php echo base_url() ?>mahasiswa/voting/?pilihblj=<?php echo $kb_id ?>" class="btn btn-success btn-lg">PILIH</a>
									</center>
								</td>
							</tr>
						</table>
